...
public class Bot1327959792068 extends Player {
	Game g;
...
if ( and (and (numPlanetsLessThan (totalOfPlanetsFromPlayer ( playerIdWithLessFleets ()  ), totalOfPlanetsFromPlayer ( playerIdWithMoreFleets ()  ) ), numPlanetsLessThan (totalOfPlanetsFromPlayer ( playerIdWithLessFleets ()  ), totalOfPlanetsFromPlayer ( myId ()  ) ) ), and (numFleetsLessThan (totalOfFleetsFromPlayer ( playerIdWithLessPlanets ()  ), totalOfFleetsFromPlayer ( playerIdWithMorePlanets ()  ) ), numShipGreaterThan (totalOfShipsFromPlayer ( playerIdWithMoreShips ()  ), totalOfShipsFromPlayer ( playerIdWithMoreShips ()  ) ) ) ) ) {
if ( and (and (numPlanetsEquals (totalOfPlanetsFromPlayer ( playerIdWithLessFleets ()  ), totalOfPlanetsFromPlayer ( playerIdWithMoreShips ()  ) ), not ( numPlanetsEquals (totalOfPlanetsFromPlayer ( myId ()  ), totalOfPlanetsFromPlayer ( playerIdWithLessPlanets ()  ) ) ) ), and (numFleetsLessThan (totalOfFleetsFromPlayer ( myId ()  ), totalOfFleetsFromPlayer ( playerIdWithMoreShips ()  ) ), numShipLessThan (totalOfShipsFromPlayer ( playerIdWithLessFleets ()  ), totalOfShipsFromPlayer ( playerIdWithMoreShips ()  ) ) ) ) ) {
...
botOrders.addAll(overwhelm (myFastestGrowing () , strongest ( enemy ()  ) ));
} 
 else {if ( or (numShipGreaterThan (totalOfShipsFromPlayer ( playerIdWithMorePlanets ()  ), totalOfShipsFromPlayer ( myId ()  ) ), or (or (numShipEquals (totalOfShipsFromPlayer ( playerIdWithMorePlanets ()  ), totalOfShipsFromPlayer ( playerIdWithMoreShips ()  ) ), and (numPlanetsGreaterThan (totalOfPlanetsFromPlayer ( playerIdWithMorePlanets ()  ), totalOfPlanetsFromPlayer ( playerIdWithMoreShips ()  ) ), fleetInFlight ()  ) ), numFleetsEquals (totalOfFleetsFromPlayer ( playerIdWithLessPlanets ()  ), totalOfFleetsFromPlayer ( playerIdWithLessPlanets ()  ) ) ) ) ) {
botOrders.addAll(issueOrderPercentageOfDestination ( mySlowestGrowing () , strongest ( ownedBy ( playerIdWithMoreShips ()  ) ), porcentaje045 ()  ) );
} 
 else {botOrders.addAll(issueOrderToNearestPercentageOfOrigin ( myStrongest () , neutral () , porcentaje030 ()  ) );
} } } 
 else {if ( numShipEquals (totalOfShipsFromPlayer ( playerIdWithLessPlanets ()  ), totalOfShipsFromPlayer ( playerIdWithMorePlanets ()  ) ) ) {
botOrders.addAll(issueOrderPercentageOfOrigin ( mySlowestGrowing () , strongest ( ownedBy ( playerIdWithMoreShips ()  ) ), porcentaje015 ()  ) );
} 
 else {botOrders.addAll(issueOrderPercentageOfDestination ( myStrongest () , slowestGrowing ( neutral ()  ), porcentaje045 ()  ) );
} } } 
 else {if ( numPlanetsEquals (totalOfPlanetsFromPlayer ( myId ()  ), totalOfPlanetsFromPlayer ( playerIdWithMoreShips ()  ) ) ) {
if ( numFleetsLessThan (totalOfFleetsFromPlayer ( playerIdWithMoreShips ()  ), totalOfFleetsFromPlayer ( playerIdWithMorePlanets ()  ) ) ) {
botOrders.addAll(issueOrderToNearestPercentageOfDestination ( myWeakest () , all () , porcentaje040 ()  ) );
} 
 else {botOrders.addAll(issueOrderPercentageOfOrigin ( myStrongest () , slowestGrowing ( all ()  ), porcentaje080 ()  ) );
} } 
 else {if ( numFleetsEquals (totalOfFleetsFromPlayer ( playerIdWithMoreShips ()  ), totalOfFleetsFromPlayer ( playerIdWithLessPlanets ()  ) ) ) {
botOrders.addAll(issueOrderPercentageOfDestination ( myFastestGrowing () , strongest ( enemy ()  ), porcentaje080 ()  ) );
} 
 else {botOrders.addAll(issueOrderPercentageOfOrigin ( myStrongest () , weakest ( all ()  ), porcentaje005 ()  ) );
} } } } 
 else {if ( and (numFleetsGreaterThan (totalOfFleetsFromPlayer ( playerIdWithMoreFleets ()  ), totalOfFleetsFromPlayer ( playerIdWithLessFleets ()  ) ), numPlanetsGreaterThan (totalOfPlanetsFromPlayer ( playerIdWithLessShips ()  ), totalOfPlanetsFromPlayer ( playerIdWithMoreFleets ()  ) ) ) ) {
if ( numShipEquals (totalOfShipsFromPlayer ( myId ()  ), totalOfShipsFromPlayer ( playerIdWithMorePlanets ()  ) ) ) {
if ( numShipLessThan (totalOfShipsFromPlayer ( playerIdWithLessShips ()  ), totalOfShipsFromPlayer ( playerIdWithMoreFleets ()  ) ) ) {
botOrders.addAll(issueOrderToNearestPercentageOfOrigin ( mySlowestGrowing () , all () , porcentaje025 ()  ) );
} 
 else {botOrders.addAll(overwhelm (myStrongest () , weakest ( ownedBy ( playerIdWithLessFleets ()  ) ) ));
} } 
 else {if ( or (numShipLessThan (totalOfShipsFromPlayer ( playerIdWithLessShips ()  ), totalOfShipsFromPlayer ( playerIdWithMoreShips ()  ) ), numPlanetsGreaterThan (totalOfPlanetsFromPlayer ( playerIdWithMoreShips ()  ), totalOfPlanetsFromPlayer ( playerIdWithLessPlanets ()  ) ) ) ) {
botOrders.addAll(issueOrderToNearestPercentageOfOrigin ( myStrongest () , all () , porcentaje065 ()  ) );
} 
 else {botOrders.addAll(issueOrderPercentageOfOrigin ( myStrongest () , weakest ( all ()  ), porcentaje050 ()  ) );
} } } 
 else {if ( numPlanetsGreaterThan (totalOfPlanetsFromPlayer ( playerIdWithLessPlanets ()  ), totalOfPlanetsFromPlayer ( myId ()  ) ) ) {
if ( playerIDEquals (playerIdWithMorePlanets () , playerIdWithLessFleets ()  ) ) {
botOrders.addAll(issueOrderToNearestPercentageOfOrigin ( myStrongest () , enemy () , porcentaje050 ()  ) );
} 
 else {botOrders.addAll(issueOrderToNearestPercentageOfDestination ( myWeakest () , enemy () , porcentaje065 ()  ) );
} } 
 else {if ( numFleetsEquals (totalOfFleetsFromPlayer ( playerIdWithLessFleets ()  ), totalOfFleetsFromPlayer ( playerIdWithMorePlanets ()  ) ) ) {
botOrders.addAll(issueOrderToNearestPercentageOfOrigin ( myStrongest () , enemy () , porcentaje050 ()  ) );
} 
 else {botOrders.addAll(issueOrderPercentageOfOrigin ( myStrongest () , weakest ( enemy ()  ), porcentaje020 ()  ) );
} } } } 
