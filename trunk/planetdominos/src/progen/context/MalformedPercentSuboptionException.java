 ...
 * define subopciones como porcentajes y la suma de todas las subopciones 
 * no sume un 100%.
 * @author jirsis
 *
 */
public class MalformedPercentSuboptionException extends RuntimeException {
	...
	/**
	 * Constructor de la excepción en la que se proporciona el nombre
	 * de la propiedad que no cumple con el requisito de que todas
	 * las subopciones sumen un 100% en el porcentaje. 
	 * @param message Nombre de la propiedad que no cumple la condición.
	 */
