 ...
 * <ul>
 *  <li>
 *  	Axioma: Símbolo no terminal del que se empieza a derivar todo el 
 *  	árbol de generación.
 *  </li>
 *  <li>
 *  	No terminales: Conjunto de símbolos auxiliares que no pueden aparecer
 *  	en la palabra final que se defina a través de la gramática. Son símbolos
 *  	auxiliares que ayudan a evolucionar cada palabra intermedia hasta una final.
 *  </li>
 *  <li>
 *  	Terminales: Conjunto de símbolos que aparecen en la palabra final.
 *  </li>
 *  <li>
 ...
 * </ul>
 * 
 * La gramáticas válidas para ProGen son gramáticas de tipo 2 (independientes de contexto)
 * en la que todas las producciones que se definan, tienen que ser recursivas lineales a izquierdas.
 * 
 * @author jirsis
 * @since 2.0
 */
public class Grammar {
	...
	/** 
	 * Conjunto de producciones que generarán una palabra válida por 
	 ...
	 * estilo "RPB" o "ADF", de tal forma que se inicialicen los valores y 
	 * se realicen las comprobaciones pertinentes para asegurarse de que la
	 * gramática está bien formada y no tenga problemas que impidan ejecutar más 
	 * adelante los árboles generados.
	 *
	 * @param idTree Identificador del árbol que utilizará esta gramática. Deberá recibir
	 * algo del estilo "RPBx" o "ADFx", donde x es un entero &gt;= 0. 
	 */
	...
	/**
	 * Devuelve el símbolo no terminal por el que se empieza a derivar toda la palabra.
	 ...
	 * @param symbol símbolo que aparece en la parte izquierda de la producción.
	...
	/**
	 * Devuelve el conjunto de producciones en las que se utiliza el símbolo
	 * no terminal proporcionado como parámetro para poder ejecutar esa producción.
	 * @param left símbolo que aparece en la parte izquierda de la producción. 
	 * @return Conjunto de producciones que se pueden derivar a partir del símbolo. 
	 */
	...
	/**
	 * Devuelve el conjunto de producciones en las que aparece en la parte izquierda
	 * el símbolo deseado, de tal forma que el orden de las producciones del conjunto
	 * es aleatorio.
	 * @param left Símbolo que genera la producción.
	 ...
	 * definidas. 
	 * @return <code>true</code> si cumple con todas las restriccioines y <code>false</code> 
	 * en caso contrario.
	 * @see progen.kernel.grammar.validations
	 */
	public boolean validate(){
		return new GrammarCheck(this).validate();
	}

	/**
	 * Define todas y cada una de las producciones que se especifican en el identificador
	 * de function-set pasado por parámetro, indicando si se ha podido llevar la operación
	 * a cabo o no.
	 * @param functionSet identificador de <i>function-set</i> que definirá el conjunto
	 * de producciones que es necesario crear.
	 * @return <code>true</code> si se crearon todas las producciones definidas en el 
	 * <i>function-set</i> o <code>false</code> en caso contrario. 
	 */
	 ...
	 * se representarán las producciones, ya que el resto de elementos que 
	 * definen la gramática, se pueden obtener de forma inmediata viendo esta información
	...
	/**
	 * Devuelve el símbolo no terminal que genera un valor de retorno pasado por parámetro.
	 * En el caso de que ya exista un no-terminal que genere ese mismo valor de retorno, 
	 * no se crea uno nuevo y se devuelve el que se haya encontrado. En caso contrario, 
	 * se crea un nuevo símbolo no terminal y se añade al conjunto de no terminales de la 
	 * gramática.
	 * @param returnValue Valor que tendrá que retornar este símbolo no terminal.
	 * @return El símbolo no terminal que cumple con la condición de generar ese valor 
	 * de retorno.
	 */
	private GrammarNonTerminalSymbol getGrammarNonTerminalSymbol(Object returnValue) {
		...
		if (!find) {
			symbol = new GrammarNonTerminalSymbol("R" + (grammarNonTerminalSymbols.size() - 1),
					(String) returnValue);
	...
	/**
	 * Devuelve el conjunto de símbolos no terminales que generar los distintos valores 
	 * de retorno proporcionados como parámetro.
	 * @param returnValue conjunto de valores de retorno de los que se quiere obtener
	 * los símbolos no terminales de los que se pueden generar. 
	 * @return Conjunto de símbolos no terminales que generan los distintos valores
	 * de retorno
	 */
	private GrammarNonTerminalSymbol[] getGrammarNonTerminalSymbol(Object returnValue[]) {
	 ...
	 * @param idADF identificador del ADF.
	 */
	...
	/**
	 * Método estático que creará las instancias de la gramática que vendrá identifada por el parámetro
	 * 
	 * @param idTree Identificador del árbol del que se quiere generar la gramática.
