 ...
 * @since 2.0
 */
public abstract class ERC extends Terminal {
	...
	/**
	 * En el caso de los ERC, por definición no se puede volver a redefinir el valor del mismo.
	 * Esto se consigue marcando el método como <code>final</code> y así 
	 * todos los ERC que se definan en el futuro, no podrán sobreescribir dicho método, cumpliendo
	 * con el requerimiento de impedir la redefinición del valor. 
	 */
	@Override
