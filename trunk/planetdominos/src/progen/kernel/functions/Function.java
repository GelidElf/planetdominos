...
/**
 * Clase abstracta que define los métodos necesarios para acceder a las distintas funciones
 * que se definan en ProGen.
 * 
 * @author jirsis
 * @since 2.0
 */
public abstract class Function implements Comparable<Function>{
	...
	/**
	 * Constructor por defecto de una función. Recibe la signatura de la misma y el símbolo que 
	 * la identifica. 
	 * 
	 * El formato esperado en la signatura es <code>valorDeRetorno$$arg1$$arg2$$...$$argN</code>
	 * @param signature Signatura de la función.
	 * @param symbol Símbolo que identificará la función.
	 */
	 ...
	 * @param symbol El nuevo identificador de la función.
	 */
	...
	/**
	 * Devuelve una instancia concreta a partir del nombre de la función que se desea instanciar.
	 * 
	 * @param functionName el nombre de la función.
     * @return una instancia de la función solicitada.
	 * @throws FunctionNotFoundException En caso de que no se encuentre la función en el paquete 
	 * del usuario o en el paquete de funciones de la aplicación, en ese orden.
	 * @throws UndefinedFunctionSetException En el caso de instanciar un ADF que no esté 
	 * definido en el function-set correspondiente.
	 */
	 ...
	 * @param arguments conjunto de argumentos que se definieron a la hora de crear la función.
	 * @param userProgram referencia al dominio creado por el usuario por si necesitara utilizar 
	 * algún método declarado él.
	 * @param returnAddr Valor de retorno de las llamadas a ADFs
