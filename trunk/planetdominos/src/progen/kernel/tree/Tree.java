...
public class Tree implements Cloneable{
	...
	/**
	 * Constructor de copia que recibe por parámetro otro árbol del que copiar los datos.
	 * @param tree El árbol a copiar.
	 */
	...
	/**
	 * Constructor de la clase. Se configura el método de inicialización definiendo
	 * en el fichero de configuración del usuario la propiedad 
	 ...
	 */
	public Tree(){
		String init=ProGenContext.getMandatoryProperty("progen.population.init-mode");
		if(init.equals("full")){
			initMethod=new Full();
	 ...
	 * @param grammar de la que se usarán las producciones para generar el árbol.
	 */
	 ...
	 * @return <code>String</code> con la representación del árbol con formato de Lisp 
	 */
	...
	/**
	 * Evalúa el árbol de tal forma que se devuelve el valor después de ejecutar todo el 
	 * programa almacenado en este árbol. 
	 * @param userProgram Definición concreta del dominio del problema que necesitará
	 * el árbol para ser evaluado.
	...
	/**
	 * Devuelve el nodo que está en la posición en preorden indicada como parámetro.
	 * @param position La posición dentro del árbol.
	 * @return El nodo que está en la posición solicitada o <code>null</code> la posición está fuera
