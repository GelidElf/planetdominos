...
/**
 * Clase que proporciona todos los métodos necesarios para gestionar
 * un nodo, así como de la modificación de su contenido y calculo 
...
public class Node implements Cloneable {
	 ...
	 * @param symbol Símbolo que estará almacenado en el nodo.
	 */
	public Node(GrammarNonTerminalSymbol symbol) {
		this.parent = null;
		this.branches = new ArrayList<Node>();
		this.symbol = symbol;
		this.function = new GrammarTerminalSymbol(new NullFunction(symbol
				.toString()));
		this.depth = 0;
		this.totalNodes = 1;
	}
	 ...
	 * 
	 * @param node El nodo del que obtener la información de copia.
	 * @param parent El nodo padre del nodo a copiar.
	 */
	...
	/**
	 * La clonación de un nodo implica crear nuevos nodos copia a partir de uno dado.
	 * Se recomienda clonar a partir de un nodo raíz.
	 * @return Node clonado.
	...
	/**
	 * Constructor de la clase que recibe un símbolo no terminal y el pader para 
	 * que queden enlazados.
	 * @param symbol Símbolo no terminal que se almacenará en el nodo.
 	 * @param parent Nodo que será el pader del actual.
	 */
	 ...
	 * @param function La función que contiene el nodo.
	 */
	 ...
	 * @return el padre del nodo actual o <code>null</code> en caso de ser la raíz. 
	 */
	...
	/**
	 * Define a que profundidad se encunetra el nodo
	 * y actualiza la profundidad de todas sus ramas. 
	 * @param depth la nueva profundidad.
	 */
	...
	/**
	 * Completa la información del nodo a partir de una producción pasada por parámetro.
	 * @param production La producción de la que obtiene la información.
	 */
	 ...
	 * @param branch Rama a colocar.
	 * @param branchPosition Posición de la rama.
	 */
	...
	/**
	 * Separa al nodo del árbol del que forma parte quedando
	 * como raíz del subárbol que definía. Actualiza y define todos
	 * los atributos de tal forma que es la raíz de un árbol.
	...
	/**
	 * Actualiza el número total de nodos que cuelgan de un nodo 
	 * y de los nodos que están por encima de él hasta llegar a la raíz.
	 * @param n El número de nodos a actualizar.
	 */
	...
	/**
	 * Limpia el contenido del nodo en concreto y de todas las 
	 * ramas que tenía.
	 */
	...
	/**
	 * Comprueba si el nodo es un nodo hoja o no, esto es, si tiene
	 * alguna rama o no.
	 * @return <code>true</code> si es una hoja y <code>false</code>
	 * en caso contrario.
	 */
	...
	/**
	 * Comprueba si el nodo es un nodo raíz o no, esto es, si tiene
	 * algún nodo que sea padre suyo.
	 * @return <code>true</code> si es la raíz y <code>false</code>
	 * en caso contrario.
	 */
	 ...
	 * @param userProgram Representación del dominio implementado por el usuario.
	 * @param returnAddr Dirección de retorno de las llamadas a ADFs. 
	 ...
	 * @param position La posición del nodo buscado.
	 * @return El nodo que está en la posición solicitada o <code>null</code>
	 * si solicitó un nodo fuera de los rangos permitidos.
	 */
	 ...
	 * @param position Posición del nodo que se quiere buscar.
	...
	/**
	 * Devuelve la profundidad a la que se encuentra el nodo más profundo
	 * de todos los hijos que tenga un nodo concreto.
