...
public class Population {
	...
	/**
	 * Gramáticas que definirán los distintos árboles que representa a un individuo.
	 * 
	 * @see Individual
	 */
	...
	/** 
	 * Constructor genérico de la clase. Carga la población en función del 
	 * tamaño definido en el fichero de configuración, a través
	 * de la propiedad <code>progen.population.size</code>
	 * 
	 */
	public Population(){
		int populationSize = Integer.parseInt(ProGenContext
				.getMandatoryProperty("progen.population.size"));
	...
	/**
	 * Constructor de la clase que crea una población del tamaño especificado
	 * en el parámetro.
	 * @param populationSize Tamaño de la población a crear.
	 */
	...
	/**
	 * Crea las estructuras de las gramáticas que se utilizarán para crear
	 * todos los árboles de los individuos.
	 */
	private void loadGrammars(){
		totalRPB = Integer.parseInt(ProGenContext
				.getMandatoryProperty("progen.total.RPB"));
	...
	/**
	 * Crea todas las gramáticas de un tipo determinado, RPB o ADF. 
	 * Cargará en memoria una única instancia de la gramática generada
	 * por cada function-set, de tal forma, que si varios árboles 
	 * comparten el mismo function-set, tendrán la misma referencia
	 * a la gramática que lo genera. 
	 * @param type El tipo de gramática a cargar, [RPB | ADF].
	 * @param total Número total de gramáticas que hay que cargar.
	 * 
	 */
	private void loadGrammar(String type, int total){
		Grammar grammarLoaded=null;
		String functionSet;
	...
	/**
	 * Inicialización del conjunto de individuos, indicando el tamaño de la población.
	...
	/**
	 * Representación de la población en forma de String. Se consigue una representación
	 * de todos los individuos que conforman cada población.
	 */
	public String toString() {
		StringBuilder stb = new StringBuilder();
		for (int i = 0; i < individuals.size(); i++) {
			stb.append(individuals.get(i) + "\n");
		}
		return stb.toString();
	}
	 ...
	 * @param id El identificador del individuo.
	...
	/**
	 * Método para establecer un nuevo conjunto de individuos que formará la población.
	 * @param individuals El nuevo conjunto de individuos que define la población.
	 */
