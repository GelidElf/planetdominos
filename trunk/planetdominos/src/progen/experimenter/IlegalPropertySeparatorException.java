...
/**
 * 
 * Excepción que será lanzada cuando se esté procesando una propiedad en el experimenter
 * que no tenga los campos separados por un separador válido.
 * @author jirsis
 * @since 2.0
 */
public class IlegalPropertySeparatorException extends RuntimeException {
	 ...
	 * @param label La propiedad mal definida.
	 */
