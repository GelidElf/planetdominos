...
/**
 * Clase principal del programa. Desde el método main, se inicializan todos los Singleton
 * existentes y se instancia el rol concreto de ejecución de la aplicación.
 * @author jirsis
 * @since 2.0
 */
public class ProGen {
	...
	/**
	 * Método principal de la aplicación en la que se inicializan los elementos estáticos
	 * de la aplicación y se ejecuta el rol que corresponde según esté definido en el fichero 
	 * de configuración pasado como parámetro.
	 * @param args Fichero <code>master-file</code> en el que se define la configuración de 
	 * la ejecución de ProGen
	 * 
	 * @see progen.roles
	 */
	public static void main(String[] args){
		...
		if(args.length!=1){
			...
			try {
				...
				store = OutputStore.makeInstance();
