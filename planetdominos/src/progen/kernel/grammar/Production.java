...
/**
 * Clase que representa las producciones de la gramática que generará todos los programas
 ...
 * 
 * 
 * En este caso, como los terminales de la gramática, son funciones los símbolos no terminales
 * que están a la derecha, son los argumentos que necesita dicha función.
 *
 * @author jirsis
 * @since v2.0
 */
public class Production {
	...
	/**
	 * Representa la parte izquierda de la producción (A, en la descripción general)
	 */
	 ...
	 * @param function función de la producción.
	 * @param args no terminales de la parte derecha de la producción. Con este conjunto de 
	 * no terminales, se contruyen nuevos no terminales para almecenar en esta instancia.
	 */
	...
	/**
	 * Representación en forma de <code>String</code> de la producción.
	 * Esta representación es de la forma <code> A -> b C </code>
	 */
	...
	/**
	 * Comprueba si el símbolo no terminal pasado por parámetro se puede generar directamente
	 * ejecutando esta Production.
	 * 
	 * @param symbol a comprobar si es generado en esta producción.
	 * @return <code>true</code> si se genera, devuelve <code>false</code> si no lo es.
	 */
	...
	/**
	 * Comprueba si el símbolo terminal pasado por parámetro se puede generar directamente
	 * ejecutando esta Production.
	 * 
	 * @param symbol a comprobar si es generado en esta producción.
	 * @return <code>true</code> si se genera, devuelve <code>false</code> si no lo es.
	 ...
	 * 
	 * @param other Object para comparar.
	...
	/**
	 * Comprueba si la Production pasada por parámetro es igual a la instancia <code>this</code>
	 * 
	 * @param other Production para comparar
	 * @return <code>true</code> si son iguales, <code>false</code> en caso contrario.
	 */
	...
	/**
	 * Método que crea una nueva <code>Production</code> a partir del <code>GrammarTerminalSymbol</code>
	 * pasado por parámetro. Únicamente se creará esta nueva producción si el terminal coincide 
	 * con la <code>Production</code> actual, en caso contrario, se devolverá una referencia a esta misma.
	 * @param newSymbol el símbolo nuevo con el que se creará la nueva <code>Production</code>.
