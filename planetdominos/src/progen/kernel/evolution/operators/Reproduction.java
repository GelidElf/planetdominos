...
/**
 * Clase que implementa el operador genético de Reproducción.
 * Lo que realiza este operador es seleccionar un individuo a través del selector
 * que se haya escogido y se devuelve tal cual.
 * 
 * @author jirsis
 * @since 2.0
 *
