...
/**
 * Clase abstracta que representa a los elementos terminales tal y como se entienden en
 * Programación Genética.
 * 
 * Define los métodos necesarios para definir los distintos tipos de elementos terminales.
 * 
 * @author jirsis
 * @since 2.0
 */
public abstract class Terminal extends Function {
	...
	/**
	 * Constructor por defecto que recibe dos parámetros y llama al 
	 * constructor de la clase padre
	 * @see Function
	 * @param signature valor de retorno del terminal.
	 * @param symbol con el que se representará el terminal.
	 */
	 ...
	 * @param value el valor del terminal.
	 */
