...
/**
 * Representación de todos los datos históricos disponibles en la ejecución de Progen.
 * Se almacenan todos los datos históricos categorizados por tipo de DataGenerator y 
 * generación de la evolución.
 * 
 * @author jirsis
 * @since 2.0
...
public class HistoricalData {
	...
	/** Colección de todos los recolectores de datos a lo largo de las generaciónes. */
	...
	/** 
	 * Constructor genérico de la clase, en la que se inicializan los valores iniciales.
	 */
	private HistoricalData(){
		//default value is negative because newGeneration() increase this value and really start in 0
		currentGeneration=-1;		
	...
	/**
	 * Forma de obtener la única instancia que existirá a lo largo de la ejecución de ProGen.
	 * 
	 ...
	 * del colector. 
	 * @param name El nombre del colector a recuperar.
	 * @return El colector deseado o uno que no continene plugins en caso de que no exista.
	 */
	 ...
	 * @param name El nombre del DataCollector.
	...
	/**
	 * Obtiene el DataColector de la generación especificada, identificada por el nombre
	 * del colector. 
	 * @param name El nombre del colector a recuperar.
	 * @param generation La generación de la que se quieren obtener los datos.
	...
	/**
	 * Obtiene el DataCollector general del experimento, identificado por el nombre
	 * del colector.
	 * @param name EL nombre del colector a recuperar.
	 * @return El colector deseado o <code>null</code> en caso de que no exista.
	 */
	 ...
	 * por una etiqueta.
	 * @param tag Etiqueta que identificará al DataCollector correspondiente.
	 */
