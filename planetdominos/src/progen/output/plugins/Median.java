...
public class Median implements Plugin {
	...
	/**
	 * Devuelve el elemento que está en la posición de la mitad de la colección, o en 
	 * la inmediatamente inferior en caso de que el número de elementos sea impar.
	 */
	@SuppressWarnings("unchecked")
