...
public interface MacroPlugin extends Plugin {
	 ...
	 * recibe como parámetro la colección de plugins que ya están añadidos
	 * al macroPlugin, de tal forma que si un plugin concreto necesita 
	 * algún otro, pueda añadirlo si no existe ya en la colección.
	 * 
	 * @param pluginsCollection Colección de plugins que ya están añadidos. 
	 * @param plugin A añadir a la colección.
	 */
