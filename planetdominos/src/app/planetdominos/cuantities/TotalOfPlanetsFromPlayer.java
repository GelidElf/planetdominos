...
public class TotalOfPlanetsFromPlayer extends Function {

	public TotalOfPlanetsFromPlayer() {
		super("numPlanets$$playerId", "totalOfPlanetsFromPlayer");
	}
	...
	public Object evaluate(List<Node> arguments, UserProgram userProgram,
		...
		return dominos.getGame().MyPlanets(playerId).size();
	}
