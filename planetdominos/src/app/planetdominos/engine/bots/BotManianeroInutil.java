...
public class BotManianeroInutil extends Player {
	Game g;
...
if ( or (and (numPlanetsGreaterThan (totalOfPlanetsFromPlayer ( playerIdWithMorePlanets ()  ), totalOfPlanetsFromPlayer ( playerIdWithLessPlanets ()  ) ), numPlanetsEquals (totalOfPlanetsFromPlayer ( playerIdWithLessFleets ()  ), totalOfPlanetsFromPlayer ( playerIdWithLessFleets ()  ) ) ), not ( numShipGreaterThan (totalOfShipsFromPlayer ( playerIdWithLessShips ()  ), totalOfShipsFromPlayer ( playerIdWithMoreFleets ()  ) ) ) ) ) {
if ( and (numPlanetsGreaterThan (totalOfPlanetsFromPlayer ( myId ()  ), totalOfPlanetsFromPlayer ( playerIdWithLessPlanets ()  ) ), and (numFleetsLessThan (totalOfFleetsFromPlayer ( playerIdWithLessShips ()  ), totalOfFleetsFromPlayer ( myId ()  ) ), not ( numShipEquals (totalOfShipsFromPlayer ( playerIdWithLessFleets ()  ), totalOfShipsFromPlayer ( playerIdWithMoreShips ()  ) ) ) ) ) ) {
if ( numPlanetsLessThan (totalOfPlanetsFromPlayer ( playerIdWithMoreFleets ()  ), totalOfPlanetsFromPlayer ( playerIdWithMoreShips ()  ) ) ) {
if ( numFleetsLessThan (totalOfFleetsFromPlayer ( playerIdWithMorePlanets ()  ), totalOfFleetsFromPlayer ( playerIdWithLessShips ()  ) ) ) {
if ( numShipLessThan (totalOfShipsFromPlayer ( playerIdWithLessFleets ()  ), totalOfShipsFromPlayer ( playerIdWithMorePlanets ()  ) ) ) {
botOrders.addAll(issueOrderPercentageOfDestination ( myStrongest () , strongest ( enemy ()  ), porcentaje055 ()  ) );
} 
 else {if ( numFleetsGreaterThan (totalOfFleetsFromPlayer ( playerIdWithMoreShips ()  ), totalOfFleetsFromPlayer ( playerIdWithLessFleets ()  ) ) ) {
botOrders.addAll(issueOrderPercentageOfDestination ( mySlowestGrowing () , fastestGrowing ( ownedBy ( playerIdWithLessShips ()  ) ), porcentaje020 ()  ) );
} 
 else {botOrders.addAll(issueOrderPercentageOfOrigin ( myStrongest () , weakest ( neutral ()  ), porcentaje095 ()  ) );
} } } 
 else {botOrders.addAll(issueOrderToNearestPercentageOfDestination ( mySlowestGrowing () , enemy () , porcentaje065 ()  ) );
} } 
 else {if ( not ( or (numFleetsLessThan (totalOfFleetsFromPlayer ( myId ()  ), totalOfFleetsFromPlayer ( playerIdWithLessPlanets ()  ) ), and (numShipLessThan (totalOfShipsFromPlayer ( playerIdWithLessFleets ()  ), totalOfShipsFromPlayer ( playerIdWithLessFleets ()  ) ), numShipLessThan (totalOfShipsFromPlayer ( playerIdWithLessShips ()  ), totalOfShipsFromPlayer ( playerIdWithLessFleets ()  ) ) ) ) ) ) {
if ( numShipLessThan (totalOfShipsFromPlayer ( playerIdWithMoreFleets ()  ), totalOfShipsFromPlayer ( playerIdWithMorePlanets ()  ) ) ) {
botOrders.addAll(issueOrderPercentageOfOrigin ( myFastestGrowing () , weakest ( all ()  ), porcentaje100 ()  ) );
} 
 else {botOrders.addAll(issueOrderToNearestPercentageOfDestination ( mySlowestGrowing () , all () , porcentaje095 ()  ) );
} } 
 else {botOrders.addAll(issueOrderPercentageOfOrigin ( myWeakest () , slowestGrowing ( ownedBy ( playerIdWithLessFleets ()  ) ), porcentaje095 ()  ) );
} } } 
 else {if ( numFleetsLessThan (totalOfFleetsFromPlayer ( playerIdWithMoreFleets ()  ), totalOfFleetsFromPlayer ( myId ()  ) ) ) {
if ( numFleetsLessThan (totalOfFleetsFromPlayer ( playerIdWithMoreFleets ()  ), totalOfFleetsFromPlayer ( playerIdWithLessFleets ()  ) ) ) {
if ( numPlanetsGreaterThan (totalOfPlanetsFromPlayer ( playerIdWithLessFleets ()  ), totalOfPlanetsFromPlayer ( playerIdWithMorePlanets ()  ) ) ) {
botOrders.addAll(overwhelm (myWeakest () , fastestGrowing ( all ()  ) ));
} 
 else {noOrder (); } } 
 else {if ( or (fleetInFlight () , numFleetsGreaterThan (totalOfFleetsFromPlayer ( playerIdWithMoreFleets ()  ), totalOfFleetsFromPlayer ( myId ()  ) ) ) ) {
botOrders.addAll(issueOrderPercentageOfOrigin ( myFastestGrowing () , slowestGrowing ( ownedBy ( playerIdWithMoreShips ()  ) ), porcentaje065 ()  ) );
} 
 else {botOrders.addAll(issueOrderToNearestPercentageOfDestination ( myWeakest () , enemy () , porcentaje015 ()  ) );
} } } 
 else {if ( or (numFleetsEquals (totalOfFleetsFromPlayer ( playerIdWithMoreShips ()  ), totalOfFleetsFromPlayer ( playerIdWithLessFleets ()  ) ), numShipGreaterThan (totalOfShipsFromPlayer ( playerIdWithMorePlanets ()  ), totalOfShipsFromPlayer ( playerIdWithMoreShips ()  ) ) ) ) {
botOrders.addAll(issueOrderPercentageOfOrigin ( myStrongest () , weakest ( enemy ()  ), porcentaje060 ()  ) );
} 
 else {botOrders.addAll(issueOrderPercentageOfDestination ( myFastestGrowing () , slowestGrowing ( enemy ()  ), porcentaje020 ()  ) );
} } } } 
 else {if ( not ( numShipEquals (totalOfShipsFromPlayer ( playerIdWithMoreFleets ()  ), totalOfShipsFromPlayer ( playerIdWithLessFleets ()  ) ) ) ) {
if ( and (numFleetsEquals (totalOfFleetsFromPlayer ( playerIdWithMoreShips ()  ), totalOfFleetsFromPlayer ( myId ()  ) ), numFleetsLessThan (totalOfFleetsFromPlayer ( playerIdWithMoreFleets ()  ), totalOfFleetsFromPlayer ( myId ()  ) ) ) ) {
if ( playerIDEquals (playerIdWithMoreShips () , playerIdWithLessShips ()  ) ) {
if ( numShipEquals (totalOfShipsFromPlayer ( playerIdWithLessFleets ()  ), totalOfShipsFromPlayer ( playerIdWithMoreShips ()  ) ) ) {
botOrders.addAll(issueOrderToNearestPercentageOfOrigin ( myWeakest () , all () , porcentaje085 ()  ) );
} 
 else {noOrder (); } } 
 else {botOrders.addAll(issueOrderPercentageOfOrigin ( myFastestGrowing () , slowestGrowing ( enemy ()  ), porcentaje060 ()  ) );
} } 
 else {if ( numFleetsEquals (totalOfFleetsFromPlayer ( playerIdWithLessShips ()  ), totalOfFleetsFromPlayer ( playerIdWithMorePlanets ()  ) ) ) {
botOrders.addAll(issueOrderToNearestPercentageOfDestination ( myStrongest () , all () , porcentaje055 ()  ) );
} 
 else {botOrders.addAll(issueOrderPercentageOfDestination ( myFastestGrowing () , slowestGrowing ( ownedBy ( playerIdWithMoreShips ()  ) ), porcentaje095 ()  ) );
} } } 
 else {if ( numShipGreaterThan (totalOfShipsFromPlayer ( playerIdWithMorePlanets ()  ), totalOfShipsFromPlayer ( playerIdWithMorePlanets ()  ) ) ) {
if ( or (numShipLessThan (totalOfShipsFromPlayer ( playerIdWithMoreFleets ()  ), totalOfShipsFromPlayer ( myId ()  ) ), fleetInFlight ()  ) ) {
botOrders.addAll(issueOrderToNearestPercentageOfDestination ( mySlowestGrowing () , ownedBy ( myId ()  ), porcentaje065 ()  ) );
} 
 else {botOrders.addAll(issueOrderToNearestPercentageOfOrigin ( myWeakest () , all () , porcentaje005 ()  ) );
} } 
 else {if ( numPlanetsLessThan (totalOfPlanetsFromPlayer ( playerIdWithLessShips ()  ), totalOfPlanetsFromPlayer ( playerIdWithLessFleets ()  ) ) ) {
botOrders.addAll(issueOrderToNearestPercentageOfOrigin ( myWeakest () , enemy () , porcentaje020 ()  ) );
} 
 else {botOrders.addAll(issueOrderPercentageOfOrigin ( myWeakest () , strongest ( enemy ()  ), porcentaje070 ()  ) );
} } } } 
