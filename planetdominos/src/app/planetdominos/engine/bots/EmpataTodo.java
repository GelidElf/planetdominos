...
public class EmpataTodo extends Player {
	Game g;
...
if ( not ( not ( numFleetsGreaterThan (totalOfFleetsFromPlayer ( playerIdWithMorePlanets ()  ), totalOfFleetsFromPlayer ( playerIdWithMorePlanets ()  ) ) ) ) ) {
if ( and (numShipGreaterThan (totalOfShipsFromPlayer ( playerIdWithMoreShips ()  ), totalOfShipsFromPlayer ( playerIdWithMoreShips ()  ) ), not ( numPlanetsEquals (totalOfPlanetsFromPlayer ( playerIdWithLessFleets ()  ), totalOfPlanetsFromPlayer ( myId ()  ) ) ) ) ) {
if ( numFleetsGreaterThan (totalOfFleetsFromPlayer ( playerIdWithLessFleets ()  ), totalOfFleetsFromPlayer ( myId ()  ) ) ) {
if ( numPlanetsEquals (totalOfPlanetsFromPlayer ( myId ()  ), totalOfPlanetsFromPlayer ( playerIdWithMoreFleets ()  ) ) ) {
botOrders.addAll(overwhelm (myFastestGrowing () , strongest ( all ()  ) ));
} 
 else {botOrders.addAll(issueOrderToNearestPercentageOfOrigin ( myStrongest () , all () , porcentaje065 ()  ) );
} } 
 else {if ( numPlanetsLessThan (totalOfPlanetsFromPlayer ( playerIdWithLessShips ()  ), totalOfPlanetsFromPlayer ( playerIdWithMoreFleets ()  ) ) ) {
if ( or (numPlanetsLessThan (totalOfPlanetsFromPlayer ( playerIdWithLessFleets ()  ), totalOfPlanetsFromPlayer ( playerIdWithLessShips ()  ) ), and (numPlanetsEquals (totalOfPlanetsFromPlayer ( myId ()  ), totalOfPlanetsFromPlayer ( playerIdWithLessPlanets ()  ) ), numPlanetsEquals (totalOfPlanetsFromPlayer ( playerIdWithMoreShips ()  ), totalOfPlanetsFromPlayer ( playerIdWithMoreFleets ()  ) ) ) ) ) {
botOrders.addAll(issueOrderToNearestPercentageOfDestination ( mySlowestGrowing () , ownedBy ( playerIdWithLessPlanets ()  ), porcentaje045 ()  ) );
} 
 else {botOrders.addAll(issueOrderPercentageOfDestination ( myStrongest () , fastestGrowing ( enemy ()  ), porcentaje085 ()  ) );
} } 
 else {botOrders.addAll(overwhelm (myStrongest () , fastestGrowing ( neutral ()  ) ));
} } } 
 else {if ( numFleetsLessThan (totalOfFleetsFromPlayer ( playerIdWithLessFleets ()  ), totalOfFleetsFromPlayer ( myId ()  ) ) ) {
if ( numFleetsGreaterThan (totalOfFleetsFromPlayer ( playerIdWithLessPlanets ()  ), totalOfFleetsFromPlayer ( playerIdWithMoreFleets ()  ) ) ) {
botOrders.addAll(issueOrderToNearestPercentageOfDestination ( myStrongest () , neutral () , porcentaje085 ()  ) );
} 
 else {botOrders.addAll(issueOrderToNearestPercentageOfDestination ( mySlowestGrowing () , ownedBy ( playerIdWithLessShips ()  ), porcentaje030 ()  ) );
} } 
 else {if ( or (playerIDEquals (myId () , myId ()  ), playerIDEquals (playerIdWithMoreFleets () , playerIdWithMorePlanets ()  ) ) ) {
botOrders.addAll(issueOrderToNearestPercentageOfDestination ( myStrongest () , enemy () , porcentaje015 ()  ) );
} 
 else {botOrders.addAll(issueOrderPercentageOfDestination ( myFastestGrowing () , strongest ( ownedBy ( playerIdWithMoreFleets ()  ) ), porcentaje030 ()  ) );
} } } } 
 else {if ( not ( numShipGreaterThan (totalOfShipsFromPlayer ( playerIdWithLessFleets ()  ), totalOfShipsFromPlayer ( playerIdWithMoreFleets ()  ) ) ) ) {
if ( numPlanetsEquals (totalOfPlanetsFromPlayer ( playerIdWithMorePlanets ()  ), totalOfPlanetsFromPlayer ( playerIdWithMorePlanets ()  ) ) ) {
if ( numShipEquals (totalOfShipsFromPlayer ( myId ()  ), totalOfShipsFromPlayer ( playerIdWithMoreFleets ()  ) ) ) {
if ( numPlanetsGreaterThan (totalOfPlanetsFromPlayer ( myId ()  ), totalOfPlanetsFromPlayer ( playerIdWithMoreShips ()  ) ) ) {
if ( numFleetsLessThan (totalOfFleetsFromPlayer ( playerIdWithMorePlanets ()  ), totalOfFleetsFromPlayer ( playerIdWithMorePlanets ()  ) ) ) {
botOrders.addAll(overwhelm (myStrongest () , weakest ( all ()  ) ));
} 
 else {botOrders.addAll(issueOrderToNearestPercentageOfOrigin ( mySlowestGrowing () , neutral () , porcentaje070 ()  ) );
} } 
 else {botOrders.addAll(issueOrderPercentageOfDestination ( myFastestGrowing () , fastestGrowing ( ownedBy ( playerIdWithLessPlanets ()  ) ), porcentaje030 ()  ) );
} } 
 else {botOrders.addAll(issueOrderToNearestPercentageOfDestination ( myFastestGrowing () , all () , porcentaje035 ()  ) );
} } 
 else {if ( numPlanetsLessThan (totalOfPlanetsFromPlayer ( playerIdWithMorePlanets ()  ), totalOfPlanetsFromPlayer ( playerIdWithLessFleets ()  ) ) ) {
botOrders.addAll(issueOrderToNearestPercentageOfOrigin ( mySlowestGrowing () , enemy () , porcentaje095 ()  ) );
} 
 else {botOrders.addAll(issueOrderToNearestPercentageOfDestination ( myWeakest () , enemy () , porcentaje015 ()  ) );
} } } 
 else {if ( numFleetsLessThan (totalOfFleetsFromPlayer ( myId ()  ), totalOfFleetsFromPlayer ( playerIdWithMoreShips ()  ) ) ) {
if ( and (numPlanetsEquals (totalOfPlanetsFromPlayer ( myId ()  ), totalOfPlanetsFromPlayer ( playerIdWithMoreFleets ()  ) ), numPlanetsEquals (totalOfPlanetsFromPlayer ( playerIdWithMorePlanets ()  ), totalOfPlanetsFromPlayer ( playerIdWithMoreFleets ()  ) ) ) ) {
botOrders.addAll(issueOrderPercentageOfDestination ( mySlowestGrowing () , strongest ( neutral ()  ), porcentaje025 ()  ) );
} 
 else {botOrders.addAll(issueOrderToNearestPercentageOfOrigin ( mySlowestGrowing () , ownedBy ( playerIdWithLessPlanets ()  ), porcentaje100 ()  ) );
} } 
 else {if ( numShipEquals (totalOfShipsFromPlayer ( playerIdWithMoreShips ()  ), totalOfShipsFromPlayer ( playerIdWithLessShips ()  ) ) ) {
if ( numPlanetsLessThan (totalOfPlanetsFromPlayer ( playerIdWithMoreFleets ()  ), totalOfPlanetsFromPlayer ( playerIdWithLessShips ()  ) ) ) {
if ( numFleetsGreaterThan (totalOfFleetsFromPlayer ( playerIdWithMoreFleets ()  ), totalOfFleetsFromPlayer ( myId ()  ) ) ) {
botOrders.addAll(issueOrderPercentageOfOrigin ( myWeakest () , strongest ( ownedBy ( playerIdWithLessPlanets ()  ) ), porcentaje090 ()  ) );
} 
 else {botOrders.addAll(issueOrderPercentageOfDestination ( mySlowestGrowing () , fastestGrowing ( enemy ()  ), porcentaje075 ()  ) );
} } 
 else {if ( numShipGreaterThan (totalOfShipsFromPlayer ( playerIdWithMoreShips ()  ), totalOfShipsFromPlayer ( myId ()  ) ) ) {
botOrders.addAll(issueOrderPercentageOfOrigin ( mySlowestGrowing () , weakest ( neutral ()  ), porcentaje050 ()  ) );
} 
 else {botOrders.addAll(issueOrderPercentageOfDestination ( myWeakest () , strongest ( ownedBy ( playerIdWithLessFleets ()  ) ), porcentaje055 ()  ) );
} } } 
 else {botOrders.addAll(issueOrderToNearestPercentageOfOrigin ( myWeakest () , enemy () , porcentaje055 ()  ) );
} } } } 
